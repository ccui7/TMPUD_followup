...
#创造task planner需要的test_cost, test_risk, 其中risk值是可以在driving过程中更新的
    ...
    os.system('python /home/cckklt/Downloads/TMP/Task-Motion-Interaction/create_facts.py')

    #os.system('python /home/yan/CARLA_0.9.6/PythonAPI/TM_selfdriving/task-level/grounding.py' + ' ' + source + ' ' + destination)
    os.system('python /home/cckklt/Downloads/TMP/Task-Motion-Interaction/grounding.py' + ' ' + source + ' ' + destination)

    #open carla
    #os.system("gnome-terminal -e '/home/yan/CARLA_0.9.6/./CarlaUE4.sh'")
    os.system("gnome-terminal -e '/home/cckklt/CARLA_0.9.10.1/./CarlaUE4.sh'")

#handler

    #os.system("gnome-terminal -e 'python /home/cckklt/Downloads/TMP/MotionPlanner_TMPUD/jamHandler.py'")
...
#set the weather, fps N, delta-seconds
    ...
    os.system("gnome-terminal -e 'python /home/cckklt/CARLA_0.9.10.1/PythonAPI/util/config.py --weather ClearNoon --fps 30'")
...
#run carla to spawn cars
    #subprocess.run('python /home/cckklt/CARLA_0.9.10.1/PythonAPI/examples/vehicle_ego_safety.py & python /home/yan/CARLA_0.9.6/PythonAPI/examples/spawn_npc_white.py -n=200',shell = True)
    #print("XXXX")
    #subprocess.run('python /home/cckklt/CARLA_0.9.10.1/PythonAPI/examples/vehicle_ego_safety.py & python /home/cckklt/CARLA_0.9.10.1/PythonAPI/examples/spawn_npc.py -n=200',shell = True)
    subprocess.run('python /home/cckklt/CARLA_0.9.10.1/PythonAPI/examples/vehicle_ego_safety.py',shell=True)
